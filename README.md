...
This repository will be home to everything in my personal collection of everything I do online! Keeping in the spirit of the indie web, I will only be using HTML, CSS, JS, and PHP ([cebe/markdown](https://github.com/cebe/markdown)? CommonMark PHP?) for this project! >:D                 
